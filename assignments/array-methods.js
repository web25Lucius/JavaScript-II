...
// return (fullNames.push(`{$items.first_name} {$items[i].last_name}`)
// )} 
// )
...
// runners.filter(large(shirt_size));
...
// ticketPriceTotal.push(runners.reduce(runners.donation(total))); 


// wrong..{
//   return( ticketPriceTotal= accumulator + total);   
// }); 
